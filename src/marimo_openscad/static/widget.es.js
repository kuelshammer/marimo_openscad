...
class A {
  constructor() {
    this.instance = null, this.isInitialized = !1, this.isInitializing = !1, this.initializationPromise = null, this.wasmBasePath = "/wasm/";
  }
  /**
...
class W {
  constructor(e) {
    this.container = e, this.scene = null, this.camera = null, this.renderer = null, this.currentMesh = null, this.wasmManager = new x(), this.lastScadCode = null, this.lastRenderId = null, this.controls = {
      mouseDown: !1,
      mouseX: 0,
      mouseY: 0,
      cameraDistance: 50,
  ...
  loadSTLData(e) {
    try {
      const { vertices: i, normals: t } = z.parseSTL(e);
      this.clearMesh();
...
function D({ model: h, el: e }) {
  ...
  try {
    ...
    if (typeof process < "u" && process.env?.NODE_ENV === "test" || typeof window < "u" && window.happyDOM || typeof global < "u" && global.happyDOM)
      ...
      if (t.textContent = "Setting up 3D scene...", n = new W(i), !n.scene || !n.renderer)
